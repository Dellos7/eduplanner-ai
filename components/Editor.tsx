          ...
          <div className="flex flex-col gap-4 bg-white p-6 rounded-xl border border-slate-200 shadow-sm shrink-0">
            <div className="flex flex-col gap-6">
              <div className="flex-1 space-y-4">
                ...
                <div className="flex flex-col gap-3 pt-2">
                   <label className="flex items-center gap-2 cursor-pointer group">
                      ...
                      <span className={`text-sm ${showTeacher ? 'text-indigo-700 font-semibold' : 'text-slate-500'}`}>Incluir Docente</span>
                   </label>
                   <label className="flex items-center gap-2 cursor-pointer group">
                      ...
                      <span className={`text-sm ${showDepartment ? 'text-indigo-700 font-semibold' : 'text-slate-500'}`}>Incluir Dept.</span>
                   </label>
                   <label className="flex items-center gap-2 cursor-pointer group">
                      ...
                      <span className={`text-sm ${showSubject ? 'text-indigo-700 font-semibold' : 'text-slate-500'}`}>Incluir Asignatura</span>
                   </label>
                   <label className="flex items-center gap-2 cursor-pointer group">
                      ...
                      <span className={`text-sm ${showPageNumbers ? 'text-indigo-700 font-semibold' : 'text-slate-500'}`}>Numeración Pág.</span>
                   </label>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-3 pt-4 border-t border-slate-100 relative">
                ...
                {validationError && (
                  <div className="absolute bottom-full right-0 mb-3 w-full bg-rose-600 text-white p-3 rounded-xl text-xs font-bold shadow-xl animate-fade-in z-50 flex items-start gap-2">
